  ...
  return (
    <>
      <section className="project-header">
        ...
        <p className="project-desc">
          本项目是一个面向音频分类任务的深度学习实践项目，主要围绕音乐流派识别展开。
          项目关注如何从音频信号中提取有效特征，并基于机器学习或深度学习模型完成不同音乐流派的分类。
        </p>

        <p className="project-desc">
          相比图像类目标检测项目，本项目更侧重音频信号处理、特征表示、分类模型训练和结果评估。
          通过该项目，我希望进一步理解信号处理方法与深度学习模型在音频分类任务中的结合方式。
        </p>
